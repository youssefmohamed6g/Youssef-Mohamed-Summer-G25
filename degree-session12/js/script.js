...
if(degree==null || degree=="" || typeof(degree)!=Number) console.log("plese enter your degree")
else{
    if(degree > 100) console.log("plese enter your corect degree")
    ...
    else if(degree<70) console.log("you git a degree (F)")
}
